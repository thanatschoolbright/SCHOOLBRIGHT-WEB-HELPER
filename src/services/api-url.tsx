...
export const API_URL = {
  ...
  PROD_SYSTEM_URL: process.env.NEXT_PUBLIC_PRODUCTION_SYSTEM_WEB_URL ?? "error",
  ...
  PROD_ACCOUNTING_WEB_URL:
    process.env.NEXT_PUBLIC_PRODUCTION_ACCOUNTING_WEB_URL ?? "error",
  PROD_ACADEMIC_WEB_URL:
    process.env.NEXT_PUBLIC_PRODUCTION_ACADEMIC_WEB_URL ?? "error",
  PROD_CANTEEN_WEB_URL:
    process.env.NEXT_PUBLIC_PRODUCTION_CANTEEN_WEB_URL ?? "error",
  PROD_SCHOOLBUS_WEB_URL:
    process.env.NEXT_PUBLIC_PRODUCTION_SCHOOLBUS_WEB_URL ?? "error",
  PROD_LIBRARY_WEB_URL:
    process.env.NEXT_PUBLIC_PRODUCTION_LIBRARY_WEB_URL ?? "error",
  PROD_MARK_ACTIVITY_WEB_URL:
    process.env.NEXT_PUBLIC_PRODUCTION_MARK_ACTIVITY_WEB_URL ?? "error",
  PROD_SYSTEM_ALPHA_TUTOR_WEB_URL:
    process.env.NEXT_PUBLIC_PRODUCTION_ALPHA_TUTOR_SYSTEM_WEB_URL ?? "error",
