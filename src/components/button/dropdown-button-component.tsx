...
export default function DropdownButtonComponent({
  ...
  const buttonClasses =
    "group relative block px-4 py-2 text-sm text-left w-full text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600 overflow-hidden border-b border-gray-200 dark:border-gray-600 last:border-0";
  ...
  return (
    <div className="relative inline-block text-left">
      ...
      <div
        id={`dropdown-${id}`}
        className="absolute right-0 mt-2 w-40 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-md shadow-lg z-10 transition-all duration-300 origin-top-right scale-95 opacity-0 pointer-events-none transform -translate-y-2"
      >
