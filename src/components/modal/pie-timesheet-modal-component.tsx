...
import {ArcElement, Chart as ChartJS, ChartType, Legend, Plugin, Title, Tooltip,} from "chart.js";
...
const centerTextPlugin: Plugin<"pie"> = {
    ...
    afterDraw(chart) {
        ...
        ctx.save();
        ctx.font = "600 18px 'LINESeedSansTH', sans-serif";
        ...
        if (chart.data?.labels?.length) {
            ctx.font = "400 13px 'LINESeedSansTH', sans-serif";
            ...
            plugins: {
                legend: {
                    ...
                    labels: {
                        ...
                        padding: 18,
                        font: {
                            family: "LINESeedSansTH, sans-serif",
                        },
