...
export function SearchableSelectComponent({
  ...
  return (
    <div className={`w-full ${hidden ? "hidden" : "bounce-once"}`} ref={ref}>
      ...
      >
        <div
          className={`flex items-center justify-between px-4 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-full min-h-[48px] flex-wrap gap-1`}
        >
          {multiselect ? (
