...
import {Button, Card, DatePicker, Input, Select, Skeleton, Space, Tabs, Typography,} from "antd";
...
const IssueFilter: React.FC<IssueFilterProps> = ({onSearch, elevatedCardStyle}) => {
