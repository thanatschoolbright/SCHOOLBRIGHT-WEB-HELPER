...
import {Button, Card, DatePicker, Select, Space, theme, Typography,} from "antd";
...
export type BulkUpdatePanelProps = {
    ...
    onAutoAiDescriptionChange: (checked: boolean) => void;
            ...
            <Space align="center" size={8} wrap>
                ...
                {showAutoCategoryToggle ? (
                    <>
                        ...
                        {/* สรุปรายละเอียดด้วย Gemini */}
                            <AutoAiDescriptionToggle enabled={autoAiDescriptionEnabled}
                                                     onChange={(checked) => onAutoAiDescriptionChange(checked)}/>
