  ...
  return (
    <DashboardLayout>
      ...
      >
        <HeaderBar
          title="Dashboard"
          subTitle="Release notes and overview"
    ...
    release_note: [
      {
        ...
        emoji: "",
        message:
          "feat(timesheet): เพิ่มระบบจัดการ Timesheet ครบวงจร พร้อม Redux Slice และ Component ใหม่",
      },
      {
        type: "add",
        emoji: "",
        message:
          "เพิ่ม TimesheetFormModal สำหรับสร้าง แก้ไข และคัดลอกรายการบันทึกเวลา",
      },
      {
        type: "add",
        emoji: "",
        message:
          "เพิ่ม TimesheetSummary สำหรับแสดงสรุปการใช้งานโปรเจกต์และฟีเจอร์ที่ใช้เวลามากที่สุด",
      },
      {
        type: "add",
        emoji: "",
        message:
          "เพิ่ม TimesheetTable สำหรับจัดการรายการบันทึกเวลา พร้อมระบบค้นหาและแบ่งหน้า",
      },
      {
        type: "update",
        emoji: "",
        message:
          "พัฒนา timesheet-slice เพื่อจัดการ state ของ Timesheet ครอบคลุม entries, projects และ modal",
      },
      {
        type: "add",
        emoji: "",
        message:
          "เพิ่ม Type สำหรับ TimesheetEntry, Project และ SubProject เพื่อให้ระบบมี Type Safety",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    release_note: [
      ...
      },
      {
        ...
        emoji: "",
        message:
          "ปรับการประมวลผล อันดับการทำงานประจำเดือน ให้แฟร์กับพนักงานมากยิ่งขึ้น",
      },
      {
        type: "update",
        emoji: "",
        message:
          "สรุปชั่วโมง จากเดิม 5 วัน จันทร์ - ศุกร์ เปลี่ยนเป็น 7 วัน จันทร์-อาทิตย์ และปรับปรุงบักการแสดงผลเมื่อถึงอาทิตย์ถัดไปแล้วยังแสดงข้อมูลอาทิตย์เก่าอยู่",
      },
      {
        type: "update",
        emoji: "",
        message:
          "ปรับตารางจากมีเส้นขอบ ให้ไม่มีเส้นขอบในตาราง ทำให้ Modern มากยิ่งขึ้น",
      },
      {
        type: "add",
        emoji: "",
        message:
          "เพิ่มเมนูใหม่ Backlog ใช้สำหรับการประมวลผล Backlog AI มีการเพิ่ม Auto Categories (จัดหมวดหมู่อัตโนมัติด้วย AI) และสรุป Task ใหม่ด้วย AI พร้อมทั้งยังสามารถ Approved ได้",
      },
    ],
  },
  {
