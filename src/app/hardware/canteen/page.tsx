...
import {
    setDraftValues as setDraftValuesCallPostCreateApplicationVersion
} from "@stores/reducers/hardware/canteen/call-post-create-application-version";
import {
    setDraftValues as setDraftValuesCallGetApplicationByAppId
} from "@stores/reducers/hardware/canteen/call-get-application-by-appId";
                              ...
                              onClick: () => {
                                  ...
                                  dispatch(
                                      setDraftValuesCallPostCreateApplicationVersion({
                                          ...
                                          appID: (STATE_HARDWARE_APPLICATION_BY_APP_ID as any)
                                              ?.draftValues?.app_id ?? "",
...
const AddOrEditVersionModal: React.FC<{
    ...
    const [form, setForm] = useState<{
        ...
        note:
            ...
            "",
        isLastestVersion: STATE_HARDWARE_CALL_POST_CREATE_APPLICATION_VERSION.draftValues.isLatestVersion || 0,
        file: null,
    });
            ...
            <div className="flex flex-col gap-4">
                ...
                >
                    ...
                    <RadioComponent
                        ...
                        label={`เป็นเวอร์ชันล่าสุดหรือไม่ คำตอบตอนนี้ : (${form.isLastestVersion ? "ใช่" : "ไม่"})`}
                        options={[
                            {label: "ใช่", value: "1"},
                            {label: "ไม่", value: "0"},
                        ]}
