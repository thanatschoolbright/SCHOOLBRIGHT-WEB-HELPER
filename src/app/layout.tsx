  ...
  return (
    <html lang="th" suppressHydrationWarning>
      ...
      >
        ...
        <div className="min-h-[calc(100vh-1rem)] sm:min-h-[calc(100vh-1.25rem)] w-full bg-white/90 dark:bg-[#141414]/90 backdrop-blur-xl rounded-[20px] sm:rounded-[28px] overflow-hidden shadow-[0_0_0_1px_rgba(0,0,0,0.05),0_20px_50px_-12px_rgba(0,0,0,0.15)] dark:shadow-[0_0_0_1px_rgba(255,255,255,0.08)] border border-white/20 dark:border-white/5 relative z-10 transition-all duration-500">
          <AntdRegistry>
            <Toaster
