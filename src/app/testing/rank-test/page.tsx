...
import { Alert, Badge, Button, Card, Progress, Space, Typography } from "antd";
  ...
  return (
    <div style={{ padding: "24px", maxWidth: "800px", margin: "0 auto" }}>
      ...
      <Space direction="vertical" size="large" style={{ width: "100%" }}>
        <Card title="API Test">
          <Space>
            <Button type="primary" loading={loading} onClick={testFetchRank}>
              Test Fetch Rank API
            </Button>
          </Space>
              ...
              description={
                <div>
                  <Badge
                    ...
                    style={{
                      backgroundColor:
                        storageData.rankLetter === "S"
                          ? "#FFD700"
                          : storageData.rankLetter === "A"
                            ? "#52C41A"
                            : "#CF1322",
                    }}
                  />
                  <Text strong>
                    {" "}
                    Rank: {storageData.rank} ({storageData.rankLetter})
                  </Text>
                  <br />
