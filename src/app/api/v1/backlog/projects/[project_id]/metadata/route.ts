...
export async function GET(request: NextRequest, context: any) {
  try {
    ...
    // Next.js 15: context.params is now a Promise
    const params = await context.params;
    const projectIdOrKey = params?.project_id;
    ...
    // Use backlog.com domain directly
    const baseUrl = `https://${space}.backlog.com/api/v2/projects/${projectIdOrKey}`;
